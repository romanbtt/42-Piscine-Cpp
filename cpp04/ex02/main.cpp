...
/*   Updated: 2021/07/30 13:00:57 by romanbtt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	{
		std::cout << "\033[1;34mTest Part 1 Polymorphism + test abstract\033[0m\n" << std::endl;
	
		const AAnimal* meta = new AAnimal();
		// Compilation error because the class Animal is now abstract

		const AAnimal* j = new Dog();
		separator();
		const AAnimal* i = new Cat();
		separator();
		const AAnimal* k = new Chicken();
		separator();
		...
		separator();
		i->makeSound(); // Woof Woof!
		separator();
		j->makeSound(); // Meow Meow!
		separator();
